//! Configuration management for the ZipLock Linux frontend
//!
...
pub use ziplock_shared::config::{
    AppConfig, ConfigManager as SharedConfigManager, FrontendConfig, RecentRepository,
    RepositoryConfig, RepositoryInfo, UiConfig,
};
...
impl ConfigManager {
    ...
    pub fn new() -> Result<Self> {
        debug!("Creating Linux frontend configuration manager");
